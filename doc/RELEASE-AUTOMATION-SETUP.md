...
This document covers the GitHub and npm setup required for the current Galyarder release model:
...
Do this for every public package that Galyarder publishes.
...
3. add a trusted publisher for the GitHub repository `galyarder/galyarder`
...
2. revoke any personal automation token that used to publish Galyarder
