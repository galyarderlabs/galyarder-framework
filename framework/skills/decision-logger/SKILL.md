...
2. **Strategic Memory (Obsidian):** Every time a significant decision is made, log it immediately using the template at `[VAULT_ROOT]/Galyarder.Framework/Decision-Logs/Decision-Log-Template.md`.
