...
3. **Strategic Memory (Obsidian):** Provide the summarized Risk Assessment to `security-guardian` to be logged in the weekly **Security Report** at `[VAULT_ROOT]/Galyarder.Framework/Department-Reports/Security/`. No dedicated assessment file is needed unless asked.
