...
3. **Strategic Memory (Obsidian):** Provide attribution insights and budget reallocation advice to the `growth-strategist` for inclusion in the weekly **Growth Report** at `[VAULT_ROOT]/Galyarder.Framework/Department-Reports/Growth/`. No standalone files unless requested.
