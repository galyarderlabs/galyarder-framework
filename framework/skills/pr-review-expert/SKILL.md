...
3. **Strategic Memory (Obsidian):** Provide your final security findings and blast radius assessment to the `super-architect` or `elite-developer` for inclusion in the weekly **Engineering Report** at `[VAULT_ROOT]/Galyarder.Framework/Department-Reports/Engineering/`. No generic "Looks Good To Me" allowed.
