...
3. **Strategic Memory (Obsidian):** Provide your acquisition strategy summary, including budget and CAC projections, to the `growth-strategist` for inclusion in the weekly **Growth Report** at `[VAULT_ROOT]/Galyarder.Framework/Department-Reports/Growth/`. No standalone files unless requested.
