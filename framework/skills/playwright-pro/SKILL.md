...
Production-grade Playwright testing toolkit adapted for the Galyarder Digital Company.

## 🛡️ Galyarder Operating Procedures (MANDATORY)
...
3. **Strategic Memory (Obsidian):** After a major test suite execution, submit a summary to `super-architect` or `elite-developer` for inclusion in the weekly **Engineering Report** at `[VAULT_ROOT]/Galyarder.Framework/Department-Reports/Engineering/`.
