...
3. **Strategic Memory (Obsidian):** Provide a summary of newly created or verified runbooks to the `devops-engineer` for inclusion in the weekly **Operations Report** at `[VAULT_ROOT]/Galyarder.Framework/Department-Reports/Operations/`.
