...
Eval framework for testing Galyarder agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the Galyarder heartbeat skill:
