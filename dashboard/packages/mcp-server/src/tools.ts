...
export function createToolDefinitions(client: GalyarderApiClient): ToolDefinition[] {
  return [
    makeTool(
      "galyarderMe",
      "Get the current authenticated Galyarder actor details",
      z.object({}),
    ...
    makeTool(
      "galyarderApiRequest",
      "Make a JSON request to an existing Galyarder /api endpoint for unsupported operations",
      apiRequestSchema,
