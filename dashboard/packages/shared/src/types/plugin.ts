...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within GalyarderPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the Galyarder host.
 *
...
export interface GalyarderPluginManifestV1 {
   ...
   */
  minimumGalyarderVersion?: PluginMinimumHostVersion;
...
export interface PluginRecord {
  ...
  manifestJson: GalyarderPluginManifestV1;
