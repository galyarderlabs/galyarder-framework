/**
 * `definePlugin` — the top-level helper for authoring a Galyarder plugin.
 *
...
// ---------------------------------------------------------------------------
// GalyarderPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 */
export interface GalyarderPlugin {
 ...
 * @returns A sealed `GalyarderPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@paperclipai/plugin-sdk";
