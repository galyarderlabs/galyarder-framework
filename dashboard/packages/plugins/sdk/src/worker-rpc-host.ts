...
import type { GalyarderPluginManifestV1 } from "@paperclipai/shared";

import type { GalyarderPlugin } from "./define-plugin.js";
import type {
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: GalyarderPluginManifestV1 | null = null;
