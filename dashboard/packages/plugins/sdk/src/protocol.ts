 ...
 * channel.
 *
 * The Galyarder plugin runtime uses JSON-RPC 2.0 over stdio to communicate
 ...
 * we use strings (UUIDs or monotonic counters) for all Galyarder messages.
 */
...
/**
 * Galyarder plugin-specific error codes.
 *
...
export interface InitializeParams {
  ...
  instanceInfo: {
    /** UUID of this Galyarder instance. */
    instanceId: string;
    /** Semver version of the running Galyarder host. */
    hostVersion: string;
  };
  /** Host API version. */
  apiVersion: number;
