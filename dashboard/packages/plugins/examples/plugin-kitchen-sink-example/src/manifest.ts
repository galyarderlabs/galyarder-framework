...
const manifest: GalyarderPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current Galyarder plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "Galyarder",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the Galyarder domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
