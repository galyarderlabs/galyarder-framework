...
function resolveGalyarderInstanceId(): string {
  const raw = process.env.GALYARDER_INSTANCE_ID?.trim() || "default";
...
function resolveDefaultConfigPath(): string {
  return path.resolve(resolveGalyarderHomeDir(), "instances", resolveGalyarderInstanceId(), "config.json");
}
...
function resolveDefaultBackupDir(): string {
  return path.resolve(resolveGalyarderHomeDir(), "instances", resolveGalyarderInstanceId(), "data", "backups");
}
