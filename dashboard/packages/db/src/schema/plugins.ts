...
import type { PluginCategory, PluginStatus, GalyarderPluginManifestV1 } from "@paperclipai/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<GalyarderPluginManifestV1>().notNull(),
