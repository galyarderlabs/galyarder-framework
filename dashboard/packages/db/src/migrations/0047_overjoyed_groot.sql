CREATE TABLE IF NOT EXISTS "feedback_exports" (
	...
	"schema_version" text DEFAULT 'galyarder-feedback-envelope-v2' NOT NULL,
	"bundle_version" text DEFAULT 'galyarder-feedback-bundle-v2' NOT NULL,
	"payload_version" text DEFAULT 'galyarder-feedback-v1' NOT NULL,
	"payload_digest" text,
