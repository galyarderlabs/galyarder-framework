...
vi.mock("../config.js", () => ({
  loadConfig: vi.fn(() => ({
    ...
    databaseUrl: "postgres://galyarder:galyarder@127.0.0.1:5432/galyarder",
    embeddedPostgresDataDir: "/tmp/galyarder-test-db",
    embeddedPostgresPort: 54329,
    databaseBackupEnabled: false,
    databaseBackupIntervalMinutes: 60,
    databaseBackupRetentionDays: 30,
    databaseBackupDir: "/tmp/galyarder-test-backups",
    serveUi: false,
    uiDevMiddleware: false,
    secretsProvider: "local_encrypted",
    secretsStrictMode: false,
    secretsMasterKeyFilePath: "/tmp/galyarder-master.key",
    storageProvider: "local_disk",
    storageLocalDiskBaseDir: "/tmp/galyarder-storage",
    storageS3Bucket: "galyarder-test",
