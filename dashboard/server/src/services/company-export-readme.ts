...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [Galyarder](https://galyarder.ing)");
  lines.push("");
  ...
  lines.push("");
  lines.push("```bash");
  lines.push("pnpm galyarder company import this-github-url-or-folder");
  lines.push("```");
  lines.push("");
