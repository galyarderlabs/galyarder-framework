...
Galyarder supports three deployment configurations, from zero-friction local to internet-facing production.
...
- **Just trying Galyarder?** Use `local_trusted` (the default)
