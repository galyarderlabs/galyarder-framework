...
- `GALYARDER_APPROVAL_ID` — the resolved approval
- `GALYARDER_APPROVAL_STATUS` — `approved` or `rejected`
- `GALYARDER_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
