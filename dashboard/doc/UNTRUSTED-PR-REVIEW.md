...
This is intentionally separate from the normal Galyarder dev image.
...
```sh
review-checkout-pr galyarder/galyarder 432
cd /work/checkouts/galyarder-galyarder/pr-432
```
...
## Preview the Galyarder app from the PR
...
- Galyarder's embedded PostgreSQL and local storage stay inside the container home volume via `GALYARDER_HOME=/home/reviewer/.galyarder-review`.
