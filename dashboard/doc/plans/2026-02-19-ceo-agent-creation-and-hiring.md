...
- installed adapter list for this Galyarder instance
...
## 8. New Skill: `galyarder-create-agent`

Create new skill directory:

- `skills/galyarder-create-agent/SKILL.md`
- `skills/galyarder-create-agent/references/api-reference.md`
...
Also update `skills/galyarder/SKILL.md` to reference this skill for hiring workflows.
...
- `galyarder-create-agent` skill + docs updates
