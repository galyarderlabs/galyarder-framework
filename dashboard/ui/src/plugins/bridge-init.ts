 ...
 *
 * This is placed on `globalThis.__galyarderPluginBridge__` and consumed by
...
declare global {
  ...
  var __galyarderPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__galyarderPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__galyarderPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
