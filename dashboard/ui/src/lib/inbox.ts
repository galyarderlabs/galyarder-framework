...
export const DISMISSED_KEY = "galyarder:inbox:dismissed";
export const READ_ITEMS_KEY = "galyarder:inbox:read-items";
export const INBOX_LAST_TAB_KEY = "galyarder:inbox:last-tab";
export const INBOX_ISSUE_COLUMNS_KEY = "galyarder:inbox:issue-columns";
