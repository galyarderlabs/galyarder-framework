        ...
        <>
            ...
            <DraftInput
              value={
                eff(
                  "adapterConfig",
                  "galyarderApiUrl",
                  String(config.galyarderApiUrl ?? ""),
                )
              }
              onCommit={(v) => mark("adapterConfig", "galyarderApiUrl", v || undefined)}
              immediate
              className={inputClass}
              placeholder="https://galyarder.example"
            />
          </Field>
          ...
          <Field label="Claimed API key path">
            <DraftInput
              ...
              immediate
              className={inputClass}
              placeholder="~/.openclaw/workspace/galyarder-claimed-api-key.json"
            />
          </Field>
          ...
          {sessionStrategy === "fixed" && (
            <Field label="Session key">
              <DraftInput
                value={eff("adapterConfig", "sessionKey", String(config.sessionKey ?? "galyarder"))}
                onCommit={(v) => mark("adapterConfig", "sessionKey", v || undefined)}
                immediate
                className={inputClass}
                placeholder="galyarder"
              />
            </Field>
          )}
          ...
          <Field label="Device auth">
            <div className="text-xs text-muted-foreground leading-relaxed">
              Always enabled for gateway agents. Galyarder Dashboard persists a device key during onboarding so pairing approvals
