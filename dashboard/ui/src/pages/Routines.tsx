...
export function Routines() {
  ...
  const routineViewStateKey = selectedCompanyId
    ? `galyarder:routines-view:${selectedCompanyId}`
    : "galyarder:routines-view";
  ...
  const runRoutine = useMutation({
    ...
    onError: (mutationError) => {
      pushToast({
        ...
        body: mutationError instanceof Error ? mutationError.message : "Galyarder could not start the routine run.",
        tone: "error",
      });
    },
  });
      ...
      <Tabs value={activeTab} onValueChange={handleTabChange}>
        ...
        <TabsContent value="runs">
          <IssuesList
            ...
            viewStateKey="galyarder:routine-recent-runs-view"
        ...
        >
          ...
          <div className="shrink-0 flex flex-col gap-3 border-t border-border/60 px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
            <div className="text-sm text-muted-foreground">
              After creation, Galyarder Dashboard takes you straight to trigger setup for schedules, webhooks, or internal runs.
            </div>
