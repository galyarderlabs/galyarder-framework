...
export async function doctor(opts: {
  ...
  p.intro(pc.bgCyan(pc.black(" galyarder doctor ")));
  ...
  try {
    ...
    const readResult: CheckResult = {
      ...
      canRepair: false,
      repairHint: "Run `galyarder configure --section database` or `galyarder onboard`",
    };
...
async function runRepairableCheck(input: {
  ...
  loadGalyarderEnvFile(input.configPath);
