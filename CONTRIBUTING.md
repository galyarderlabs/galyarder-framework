...
> - This pull request adds per-adapter configuration of compaction, either auto or galyarder managed
> - That way we can get optimal performance from any adapter/provider in Galyarder
