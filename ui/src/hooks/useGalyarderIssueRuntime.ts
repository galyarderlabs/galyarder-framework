...
export interface GalyarderIssueRuntimeReassignment {
  assigneeAgentId: string | null;
  assigneeUserId: string | null;
}

export interface GalyarderIssueRuntimeSendOptions {
  body: string;
  reopen?: boolean;
  reassignment?: GalyarderIssueRuntimeReassignment;
}

interface UseGalyarderIssueRuntimeOptions {
  messages: readonly ThreadMessage[];
  isRunning: boolean;
  onSend: (options: GalyarderIssueRuntimeSendOptions) => Promise<void>;
...
export function useGalyarderIssueRuntime({
  messages,
  isRunning,
  onSend,
  onCancel,
}: UseGalyarderIssueRuntimeOptions) {
