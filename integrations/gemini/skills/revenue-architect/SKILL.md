...
description: |
  Monetization and pricing strategy specialist. Use this agent to design revenue models, set price points based on value perception, and create compounding referral loops. It focuses on the Revenue aspect of the 1-Man Army pipeline.
model: inherit
---
