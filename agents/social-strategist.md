...
tools:
  ...
  - replace
description: |
  Social media and distribution specialist. Use this agent to manage distribution, draft Twitter/LinkedIn threads, and manage the social media distribution of new features. It focuses on the "Distribution" aspect of the 1-Man Army pipeline.
---
