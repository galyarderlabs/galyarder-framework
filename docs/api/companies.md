...
Manage companies within your Galyarder instance.
...
Company logo uploads use the normal Galyarder attachment size limit.
...
| `logoUrl` | string | Optional Galyarder asset content path for the stored logo image |
