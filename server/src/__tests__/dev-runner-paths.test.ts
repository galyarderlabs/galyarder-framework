...
describe("shouldTrackDevServerPath", () => {
  it("ignores repo-local Galyarder Dashboard state and common test file paths", () => {
    expect(
      shouldTrackDevServerPath(
        ".galyarder/worktrees/PAP-712-for-project-configuration-get-rid-of-the-overview-tab-for-now/.agents/skills/galyarder",
      ),
    ).toBe(false);
